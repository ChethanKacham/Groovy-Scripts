...
def main()
{
    //POST Method for creating route
    def token = "dDvV-I0faZUgt8p0wk4PVnC9TVxA9NXCAxtDmYJL574"
    def projectUrl = "https://openshift:6443/apis/route.openshift.io/v1/namespaces/demo/routes"
    def projectName = "demo"
    def imageName = "nginx"
    def targetPort = 8080
    def json = '{ "apiVersion": "route.openshift.io/v1", "kind": "Route", "metadata": { "name": "nginx", "namespace": "demo" }, "spec": { "path": "/", "to": { "kind": "Service", "name": "nginx" }, "port": { "targetPort": 8080 } } }'
